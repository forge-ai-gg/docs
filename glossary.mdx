...
The AI model powering your agent's decision-making. ForgeAI supports multiple LLMs including GPT-4o, Claude 3.5 Sonnet, Grok, and Llama 3. Different models have different strengths for various trading styles.
