...
### Agent
An AI-powered trading entity you create and configure on ForgeAI. Agents execute trades autonomously based on their class (Fighter, Rangers, or Mage) and your configured strategy. Each agent can level up and gain new abilities over time.
